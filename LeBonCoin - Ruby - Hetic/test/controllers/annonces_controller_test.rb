...
class AnnoncesControllerTest < ActionController::TestCase
  ...
  test "should create annonce" do
    assert_difference('Annonce.count') do
      post :create, annonce: { category_id: @annonce.category_id, description: @annonce.description, price: @annonce.price, title: @annonce.title }
    end
  ...
  test "should update annonce" do
    patch :update, id: @annonce, annonce: { category_id: @annonce.category_id, description: @annonce.description, price: @annonce.price, title: @annonce.title }
    assert_redirected_to annonce_path(assigns(:annonce))
  end
